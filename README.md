...
# 📖 [Leaderboard API!] `ES6` `WebPack` `API` <a name="about-project"></a>

Introducing Javascript app featuring the use of API's.
...
<summary>Database</summary>
  <ul>
    <li><a>It uses the leaderboard API in order to have access to the information</a></li>
  </ul>
</details>
...
- **[ES6 updated, WebPack, Dynamic Content, API]**
